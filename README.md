...
## Project Overview
This project is a web-based course portal that allows students and instructors to log in with a username and password. Based on their role, users are directed to different dashboards.
